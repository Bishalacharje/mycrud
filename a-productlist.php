...
while ($result=mysqli_fetch_assoc($data)) 
{
    echo "<tr>
            ...
            <td>".$result['fprice']."</td>
            <td>
            <a href='a-product-dt.php?pid=$result[pid]&name=$result[pname]&brand=$result[brand]&img_src=$result[img_src]&price=$result[price]&discount=$result[discount]&fprice=$result[fprice]'>
                   <span> Details </span>
                </a>
            </td>
